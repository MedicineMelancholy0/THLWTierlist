...
<!--   <p><strong>Join Touhou LostWord Unofficial here: https://discord.gg/TCjp7VMTps</strong></p>--> 
...
<!--    <p>In addition, our Calc Sheet will be ported for ease of use. Though for now, please refer to this: https://docs.google.com/spreadsheets/d/1WO4C0jde8E1bU4QU-58wwuteqLWX7e2vo1tjIZMTM7c/edit?gid=131689753#gid=131689753</p>--> 
    ...
    <a href='src/assets/title1.png' target='_blank'><img src='src/assets/title1.png' alt='title1' width="1690" height="231"></a>
<!--
    <script src="src/js/data/tierlist.js"></script>

    <script>const i = document.createElement("div");
    i.innerHTML = `<img src="${item.imageURL}" />` // you can add more stuff here, css classes, etc.

    container.appendChild(i); // container is the tier list container</script>

    <div>EX</div>
    <a href="src/assets/tiers/ex.png" target='_blank'><img src='src/assets/tiers/ex.png' alt='EX Tier' width="170" height="200"></a>
    <div id="EX">
        
    <script>i.innerHTML = <img src="src/assets/${item.img}" /></script>    

    <script>tierlist.forEach(EX)</script>
    </div>
...
<script>
  const containerEX = document.getElementById("EX"); 

  function addCharacter(item) {
    const i = document.createElement("div");
    i.style.display = "inline-block";
    i.innerHTML = `<img src="src/assets/chara/${item.img}" alt="${item.name}" />`; 
    
    containerEX.appendChild(i);
  }
...
<a href="src/assets/tiers/ss.png" target="_blank">
  <img src="src/assets/tiers/ss.png" alt="EX Tier" width="165" height="300">
</a>
...
<script>
  const containerEX = document.getElementById("SS"); 
